...
def evaluate( actual: np.ndarray,
             ...
             class_actual: np.ndarray,
             class_actual_true :np.ndarray,
    ...
    class_results = classification_report(class_actual, class_pred, output_dict=True)
    logger.info(classification_report(class_actual, class_pred))
    logger.info(classification_report(class_actual_true, class_pred))
